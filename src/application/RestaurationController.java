...
public class RestaurationController implements Initializable {
	@FXML
	...
	@FXML
	public void ajouterRes(MouseEvent event) throws IOException {
		// TODO Autogenerated
		Stage stage = new Stage();
        Parent rootA;
        rootA = FXMLLoader.load(getClass().getResource("AjouterSB.fxml"));
        Scene scene = new Scene(rootA,406,507);
